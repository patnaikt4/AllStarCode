...
-- The storage_path column points to the PDF in the 'feedback-pdfs' Supabase Storage bucket.
...
-- Updates are performed server-side via the service role (bypasses RLS).
